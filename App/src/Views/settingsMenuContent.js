...
//             <button id="closeSettingsBtn" data-mode="close-menu" data-alert="false" data-alerttitle="${language.alerts.themeEditorAlerts.title}" data-alertdesc="${language.alerts.themeEditorAlerts.desc}">
...
//                 <li data-alert="false" data-alerttitle="${language.alerts.themeEditorAlerts.title}" data-alertdesc="${language.alerts.themeEditorAlerts.desc}" data-mode="change-menu" data-category="appearance" id="settings_appearance">
//                      <legend class="settings-menu_list-legend">${language.settings.appearance.title}</legend></li>
//                 <li style="display: none;" data-alert="false" data-alerttitle="${language.alerts.themeEditorAlerts.title}" data-alertdesc="${language.alerts.themeEditorAlerts.desc}" style="display: innerit;" data-mode="change-menu" data-category="keybinds" id="settings_keybinds"><legend class="settings-menu_list-legend">Keybinds</legend></li>
//                 <li data-alert="false" data-alerttitle="${language.alerts.themeEditorAlerts.title}" data-alertdesc="${language.alerts.themeEditorAlerts.desc}" data-mode="change-menu" data-category="about" id="settings_about"><legend class="settings-menu_list-legend">${language.settings.about.title}</legend></li>
//             </ul>
//         </div>
