...
//     "edit-btn": (target) => {
//         if(target.tagName === "svg") target = document.getElementById("edit-btn")
//         popUpsManager.showPopUp("shortcutsContextMenu", target.parentNode, target.parentNode.parentNode)}
//     ,
//     "context-menu_deleteBtn": (ref) => {
//         showAlert(language.alerts.deleteShortcuts.title, language.alerts.deleteShortcuts.desc, ref.parentNode.parentNode.parentNode.parentNode, true)
