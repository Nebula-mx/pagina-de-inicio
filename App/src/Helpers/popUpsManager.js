...
//     if(popUpsElements[this.typeOfMenu].dynamicPos === true) {
//       const element = document.querySelector(popUpsElements[this.typeOfMenu].id);
//       const elementRect = element.getBoundingClientRect();
//       const parentElement = document.querySelector(popUpsElements[this.typeOfMenu].parentContainer);
//       let yTranslate = 0;
...
//       if((window.innerWidth - elementRect.right) < elementRect.width) xTranslate = -elementRect.width
